...
(function($, channel, Coral) {
    ...
    function handleConstraintMessage(dialog) {
        ...
        var displayConstraintMessage = component.value !== Granite.I18n.get("text") && component.value !== Granite.I18n.get("textarea");
        checkAndDisplay(constraintMessage,
            true,
            displayConstraintMessage);
        component.on("change", function() {
            displayConstraintMessage = this.value !== Granite.I18n.get("text") && this.value !== Granite.I18n.get("textarea");
            checkAndDisplay(constraintMessage,
                true,
                displayConstraintMessage);
        });
