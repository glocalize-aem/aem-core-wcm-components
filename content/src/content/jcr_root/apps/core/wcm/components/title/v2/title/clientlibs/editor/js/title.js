...
(function($, Granite, ns, $document) {
    ...
    var DEFAULT_SIZE_SELECTOR       = Granite.I18n.getVar("coral-select.core-title-size-default");
    var DEFAULT_SIZES_SELECTOR      = Granite.I18n.getVar("coral-select.core-title-sizes-default");
    ...
    var SIZES_SELECTOR              = Granite.I18n.getVar("coral-select.core-title-sizes");
