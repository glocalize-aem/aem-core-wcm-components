...
(function($, Granite, ns, $document) {
  ...
  var ALLOWED_SIZES_SELECTOR = Granite.I18n.get('.core-title-sizes-allowed coral-checkbox');
  var DATA_ATTR_VALIDATION_STATE = Granite.I18n.get('checkboxes.validation.state');
  var SIZES_SELECTOR = Granite.I18n.get('coral-select.core-title-sizes');
  var LINK_URL_SELECTOR = Granite.I18n.get('.cmp-title-link-url');
  var LINK_LABEL_SELECTOR = Granite.I18n.get('.cmp-title-link-label');
  var LINK_TITLE_SELECTOR = Granite.I18n.get('.cmp-title-link-title');
